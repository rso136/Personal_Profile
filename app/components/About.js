			...
			<div className="main-container">
				...
				<div className="row">
					<div className="col-xs-12 col-md-12">
						...
						<p><i>- Tim Keller, The Freedom of Self-Forgetfulness</i></p>
						<p>I am convinced that this sort of freedom is at the heart of authentic humility. As a follower of Jesus Christ, I believe that the key to this freedom is communicated through the good news about Him and it informs the way I understand my work and my life as a whole.
Succinctly put, as it relates to my work, I desire to be characterized by the sort of humility that looks outward and does good, not for the sake of self promotion but rather for its own sake, simply out of love for God and love for others.</p>
					</div>
				</div>
				<div className="row">
					<div className="col-xs-12 col-md-12" id="quote">
						<p><i>"To get even near it, even for a moment, is like a drink of cold water to a man in a desert.”</i></p>
						<p><i>- C.S. Lewis</i></p>
					</div>
				</div>
				<div className="row">
