			...
			<div className="main-container">
				...
				<div className="row">
					<div className="col-xs-12 col-md-12">
						...
						<p>I am convinced that the sort of freedom summarized in the quote above captures the essence of my vision for work. As a follower of Jesus Christ, His message informs the way I understand my work and my life as a whole.
					...
					<div className="col-xs-12 col-md-4 col-md-offset-1" id="skillsA">
						<h3>Full Stack Web Proficiencies:</h3>	
							<ul>
								...
								<li><a href="Richard_Oh_Resume.pdf">More...</a></li>			
							</ul>
					</div>
